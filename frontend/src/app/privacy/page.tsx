    ...
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed">
          ...
          <div>
            <h2 className="font-semibold text-foreground">Response accuracy</h2>
            <p className="mt-1 text-muted">
              Responses are generated by community volunteer GPUs running open-source AI models.
              They may be inaccurate, incomplete, or misleading. IdleClaw does not verify the
              correctness of model outputs. Do not rely on responses for medical, legal, financial,
